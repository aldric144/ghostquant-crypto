  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8"><h1 className="text-3xl font-bold text-cyan-400 mb-2">System Telemetry</h1><p className="text-gray-400">Real-time infrastructure health monitoring and diagnostics</p></div>
