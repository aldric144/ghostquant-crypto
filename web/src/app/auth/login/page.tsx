...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0a0e1a] via-[#0d1321] to-[#0a0e1a] flex items-center justify-center px-4">
      ...
      >
        <div className="bg-[#0d1321]/80 border border-cyan-500/30 rounded-2xl p-8 backdrop-blur-xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Sign in to access your intelligence terminal</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 text-gray-400 cursor-pointer">
                <input type="checkbox" className="w-4 h-4 rounded border-cyan-500/30 bg-[#0a0e1a] text-cyan-500 focus:ring-cyan-500/50" />
                Remember me
              </label>
