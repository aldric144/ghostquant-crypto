...
export default function Sidebar() {
  ...
  const coreMarketIntelligence: MenuSection = {
    ...
    items: [
      { href: '/assets', label: 'All Assets', icon: <ChartIcon /> },
      { href: '/momentum', label: 'Momentum', icon: <TrendingIcon /> },
      { href: '/screener', label: 'Screener', icon: <FilterIcon /> },
      { href: '/alphabrain', label: 'AlphaBrain', icon: <BrainIcon /> },
      { href: '/ecoscan', label: 'Ecoscan', icon: <GlobeIcon /> },
  ...
  // F. Governance & System Control (Wave C)
  const governanceSystemControl: MenuSection = {
    title: 'Governance & System',
    items: [
      { href: '/terminal/strategy-backtester', label: 'Strategy Backtester', icon: <StrategyIcon /> },
      { href: '/terminal/scenario-simulator', label: 'Scenario Simulator', icon: <ScenarioIcon /> },
      { href: '/terminal/alert-rules', label: 'Alert Rules Engine', icon: <AlertRulesIcon /> },
      { href: '/terminal/compliance-report', label: 'Compliance / Audit Log', icon: <ComplianceIcon /> },
      { href: '/terminal/system-telemetry', label: 'System Telemetry', icon: <TelemetryIcon /> },
      { href: '/terminal/governance-console', label: 'Governance Console', icon: <GovernanceIcon /> },
    ]
  }
  ...
  return (
    <aside className={`
      hidden md:flex flex-col bg-slate-950 border-r border-cyan-500/20 
