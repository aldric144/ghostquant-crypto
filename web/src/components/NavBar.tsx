        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-8">
            ...
            <div className="flex space-x-6">
              ...
              <a href="/momentum" className="text-gray-300 hover:text-blue-400 transition">Momentum 🚀</a>
              <a href="/screener" className="text-gray-300 hover:text-blue-400 transition">Screener</a>
